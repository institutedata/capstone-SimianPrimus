...
const AddArtwork: React.FC = () => {
  ...
  const handleSubmit = async (e: FormEvent) => {
    ...
    try {
      const response = await axios.post<ArtworkData>(
        "http://localhost:8080/api/originalArtwork",
        artworkWithUserId
      );
...
// TODO: Use upload logic and middleware to upload image file to the server using FormData
